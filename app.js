...
const greetUser = (name, timeOfDay) => {
  ...
  console.log('Exercise 5 Result:', greetUser("Seibert", "morning"));  // Should log: Good morning, Seibert
  
console.log('Exercise 5 Result:', greetUser("Mike", "morning"));
...
const maxOfThree = (x, y, z) => {
  ...
  console.log('Exercise 6 Result:', maxOfThree(17, 4, 9));  // Should log: 10
